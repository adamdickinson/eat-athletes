...
export class AgilityTest extends Component {
  ...
  async persistResults() {
    ...
    await commitMutation(relayEnvironment, { 
      mutation: graphql`
        mutation AgilityTestRecordResultsMutation ( $results: [ResultInput!]!) {
...
export default connect(mapStateToProps)(AgilityTest)
